...
Self.GetOwningQuest().ModObjectiveGlobal( Utility.RandomInt( 1, 15 ), _SDGVP_demerits, 3, _SDGVP_demerits_join.GetValue() as Float, False, True, _SDGVP_config_verboseMerits.GetValueInt() as Bool )
...
ElseIf (randomVar >= (60 - demerits)  ) ; Straining positions
...
ElseIf ((randomVar >=  (50 - demerits))) ; Dance
...
ElseIf ((randomVar >  (40 - demerits))) ; Force feed skooma
