...
event OnPageReset(string a_page)
	...
	ElseIf ( a_page == Pages[2] )
		...
		; _SDOID_config_K3 = AddKeyMapOption("$SD_KEYMAP_P2_MOVE_UP", config._SDUIP_keys[2], OPTION_FLAG_DISABLED)
		...
		; _SDOID_config_K6 = AddKeyMapOption("$SD_KEYMAP_P2_MOVE_DOWN", config._SDUIP_keys[5], OPTION_FLAG_DISABLED)
...
event OnOptionHighlight(int a_option)
	...
	ElseIf ( a_option == _SDOID_config_S9 )
		SetInfoText("Maximum value for slavery level (0 = defiant, 6 = total submissive). Should be higher than Max Slavery Level.")
