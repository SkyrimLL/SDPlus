...
fctOutfit.clearDeviceByString( sDeviceString = "Plug" )
fctOutfit.clearDeviceByString( sDeviceString = "PlugAnal" )
fctOutfit.clearDeviceByString( sDeviceString = "PlugVaginal" )
