...
Scriptname _sdtif_dream_scene6_266 Extends TopicInfo Hidden
...
Self.GetOwningQuest().SetStage(266)
Self.GetOwningQuest().SetStage(268)
_sd_sanguine_path.Setvalue(3)
...
akSpeaker.SendModEvent("PCSubSex","Foreplay") ; Sex
;END CODE
EndFunction
;END FRAGMENT
