...
;BEGIN CODE
; Blank state to track a choice of path has been made
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
SetObjectiveDisplayed(239,false)
...
;BEGIN CODE
; control quest stage between Sanguine and Crassius
SetObjectiveDisplayed(238,false)
SetObjectiveDisplayed(239)
;END CODE
EndFunction
;END FRAGMENT
