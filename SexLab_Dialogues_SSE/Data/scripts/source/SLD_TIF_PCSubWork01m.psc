...
Scriptname SLD_TIF_PCSubWork01m Extends TopicInfo Hidden
...
kPlayer.AddItem(Gold, Utility.RandomInt(1, 10 + (10 * iSlaveLevel)+ ((akSpeaker.GetAV("Confidence") as Int) + (akSpeaker.GetAV("Morality") as Int) ) * (akSpeaker.GetAV("Assistance") as Int) ), false)
