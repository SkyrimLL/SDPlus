...
Scriptname SLD_TIF_PCSubThirsty02 Extends TopicInfo Hidden
...
Actor kSlave = game.GetPlayer()
	...
	If (randomVar >= 9  ) && (StorageUtil.GetIntValue( akSpeaker , "_SD_iDisposition") < 0 )
		...
		akSpeaker.SendModEvent("SLDForceFeedPlayer","StrongSkooma",1.0)
	...
	ElseIf (randomVar >= 5  )
		...
		akSpeaker.SendModEvent("SLDForceFeedPlayer","StrongWine",1.0)
