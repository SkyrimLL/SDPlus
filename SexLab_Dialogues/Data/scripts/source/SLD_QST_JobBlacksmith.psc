...
Scriptname SLD_QST_JobBlacksmith Extends Quest Hidden
...
;BEGIN CODE
SetObjectiveDisplayed(440, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(410, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(300, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(310, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(450, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(400, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(330, abDisplayed=False)
SetObjectiveDisplayed(301, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(440, false)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
SetObjectiveDisplayed(430, abDisplayed=False)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
SetObjectiveDisplayed(320, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(170, abDisplayed=False)
...
SetObjectiveDisplayed(201, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(165, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(175, abDisplayed=False)
SetObjectiveDisplayed(101, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(160, abDisplayed=False)
...
;BEGIN CODE
SetObjectiveDisplayed(225, abDisplayed=False)
SetObjectiveDisplayed(230)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
SetObjectiveDisplayed(420, abDisplayed=False)
